# UBER Website Cloning Project
Rebuilding the landing page of the Uber website. Both grid and flexbox models were used in various different combinations in order to set up a responsive layout.   
...
You can reach the project [here](https://shamanicoder.github.io/UberWebsiteClone/index.html)
## Quiz App Demo

 <img src="UBER.png" style="max-width: 100%;">
